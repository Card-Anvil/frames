...
// Borderless ships no dedicated vehicle base frame — reuse the artifact frame
// so vehicles don't fall back to gold (m).
export { default as v } from "./a.png";
// Hybrid title/type wash is shared with the borderless regular layout.
export { default as c2 } from "../../regular/c2.png";
